...
mkdir -p /opt/dlami/nvme/chenyang/guanyitong_iterative_dpo_sglang/checkpoint/llama-3-8b-iter-dpo
GENERATE_OUTPUT=/opt/dlami/nvme/chenyang/guanyitong_iterative_dpo_sglang/checkpoint/llama-3-8b-iter-dpo/generate.jsonl
RM_OUTPUT=/opt/dlami/nvme/chenyang/guanyitong_iterative_dpo_sglang/checkpoint/llama-3-8b-iter-dpo/rm.jsonl
MODEL_OUTPUT_PATH=/opt/dlami/nvme/chenyang/guanyitong_iterative_dpo_sglang/checkpoint/llama-3-8b-iter-dpo/checkpoint
ITER_LOG_PATH=null
...
openrlhf.cli.train_dpo \
  ...
  --wandb_run_name sglang-iterative-dpo-$TIME \
  --wandb_project iterative-dpo
EOF
  echo "$dpo_commands"
